...
public class SortPerson
{
    ...
    public void sortByName(String name)
    {
        ...
        if (index >= 0) System.out.println(people.get(index));
    ...
    {
        // make a int-based comparator here
        CompareInt intComp = new CompareInt();
        // sort list people by id here
        Collections.sort(people, intComp);
        // print sorted list
        people.forEach(System.out::println);
        System.out.println("\nSearching for:");
        ...
        int index = Collections.binarySearch(people, p, intComp);
        if (index >= 0) System.out.println(people.get(index));
